		...
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
			<div class="card">
				...
				<div class="header" style="background-color: #8BC34A ">
					<form method="POST" action="<?php echo site_url('scan/getscanr');?>">
						<div class="col-lg-12"> 
							<div class="col-lg-4">   
				...
				<div class="col-md-12">
					<a href="<?php echo site_url()."stock_monitoring/ekspor2/$tipe/$hari1/$jam"?>" class="btn pull-right" role="button"><span class="glyphicon glyphicon-save-file"></span> Print Report</a>
				</div>		
