...
<body>
	...
	<div class="row clearfix">
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
			<div class="card">
				...
				<div class="header" style="background-color: orange">
					<form method="POST" action="<?php echo site_url('scan/getscans2');?>">	
						<div class="col-lg-12"> 
							<div class="col-lg-4">   
				...
				<!-- modal edit shipping -->
				<form id="add-row-form" action="<?php echo base_url().'scan/edit_shi'?>" method="post">
					<div class="modal fade" id="ModalUpdate" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
						<div class="modal-dialog modal-lg">
							<div class="modal-content">
								<div class="modal-header">
									<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
									<h2 class="modal-title" align="center" id="myModalLabel">Edit Shipping</h2>
								</div>
				...
				<form id="add-row-form" action="<?php echo base_url().'scan/delete_shi'?>" method="post">
					<div class="modal fade" id="ModalHapus" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
						<div class="modal-dialog">
							<div class="modal-content">
								<div class="modal-header">
									<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
									<h2 class="modal-title" align="center" id="myModalLabel">Delete Shipping</h2>
								</div>
				...
				<!-- modal pindah shipping -->
				<form id="add-row-form" action="<?php echo base_url().'stock_monitoring/moves/'?>" method="post">
					<div class="modal fade" id="ModalPindah" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
						<div class="modal-dialog">
							<div class="modal-content">
								<div class="modal-header">
									<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
									<h2 class="modal-title" align="center" id="myModalLabel">Move Shipping</h2>
								</div>
								<div class="modal-body">
		...
		var table=$("#mytable").dataTable({
			...
			processing: true,
			serverSide: true,
			ajax: {"url": "<?php echo base_url().'scan/get_guest_json_2'?>", "type": "POST"},
			columns: [
			{"data": "date_time"},
			{"data": "brand"},
			{"data": "cust_model"},
		...
		$('#mytable').on('click','.edit_record',function(){
			...
			$.ajax({
				type : "GET",
				url  : "<?php echo base_url('scan/get_barcode_2')?>",
				dataType : "JSON",
