		...
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
			<div class="card">
				<div class="header">
					...
					<form action="report1" method="post" align="center">
						...
						From &nbsp&nbsp&nbsp <input type="date" id="start" name="tanggal1"
						min="2018-01-01" max="2050-12-31">&nbsp&nbsp&nbsp
						to &nbsp&nbsp&nbsp
				...
				<div>
					<table class="table table-bordered table-fixed">
						...
						?>
						<a href="<?php echo site_url()."stock_monitoring/ekspor/$tanggal1/$tanggal2/$tipe/$model/$color/$size/$user"?>"><button class="btn btn-default pull-right"><span class="glyphicon glyphicon-save-file"></span> Print Selected</button></a>
						<!--<a href="<?php echo site_url()."stock_monitoring/ekspor_pivot/$tanggal1/$tanggal2/$tipe/$model/$color/$size"?>" class="btn pull-right" role="button"><span class="glyphicon glyphicon-save-file"></span>Print Summary Stock</a>-->
					</table>
				</div>
