    ...
    <nav class="navbar">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html"><img src="<?php echo base_url();?>assets/images/logo/logo_hsk.png" style="width: 68%;padding-left: 70px;margin-bottom: 200px; float: top"></a>
            </div>
...
<section>
    ...
    <aside id="leftsidebar" class="sidebar" style="overflow-y: hidden;">
     <div class="menu">
        <ul class="list">
            <li>
                <a href="<?php echo base_url();?>stock_monitoring/dashboard2">
            ...
            <li>
                ...
                <ul class="ml-menu">
                    <li>
                        <a href="<?php echo base_url();?>stock_monitoring/report">
                           <i class="material-icons">assignment_turned_in</i>
                           <span>Daily Report</span>
                       </a>
                   </li>
                   <li>
                    <a href="<?php echo base_url();?>stock_monitoring/report3">
