...
<body class="theme-blue">
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbar-collapse">
                ...
                <ul class="nav navbar-nav navbar-right">
                 ...
                 <!-- #END# Call Search -->
                 <li class="active"><?php echo anchor('login/logout','Logout');?></li>   
             </ul>
         </div>
     </div>
 </nav>
 ...
 <section>
    <!-- Left Sidebar -->
    <aside id="leftsidebar" class="sidebar" style="overflow-y: hidden;">
     <div class="menu">
        <ul class="list">
            <li>
                <a href="<?php echo base_url();?>stock_monitoring/dashboard1">
                    <i class="material-icons">home</i>
                    <span>Stock Monitoring</span>
                </a>
            </li>
            <li>
                <a href="<?php echo base_url();?>scan/viewscanreceiving2">
                    <i class="material-icons">file_download</i>
                    <span>Scan Receiving</span>
                </a>
            </li>
            <li>
                <a href="<?php echo base_url();?>scan/viewscanshipping2">
                    <i class="material-icons">file_upload</i>
                    <span>Scan Shipping</span>
                </a>
            </li>
            <li>
                ...
                <ul class="ml-menu">
                    <li>
                        <a href="<?php echo base_url();?>stock_monitoring/report1">
                           <i class="material-icons">assignment_turned_in</i>
                           <span>Daily Report</span>
                       </a>
                   </li>
                   <li>
                    <a href="<?php echo base_url();?>stock_monitoring/report2">
       ...
       <li>
        ...
        <ul class="ml-menu">
            <li>
                <a href="<?php echo base_url();?>stock_monitoring/stock">
                   <i class="material-icons">poll</i>
                   <span>Warehouse Stock</span>
               </a>
           </li>
           <li>
            <a href="<?php echo base_url();?>stock_monitoring/stock_report1">
...
<li>
    <a href="<?php echo base_url();?>stock_monitoring/master">
